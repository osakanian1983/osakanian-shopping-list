...
余白ルールを踏襲。表紙アートは著者が塗った太宰府天満宮(表表紙)と
琵琶湖・浮御堂(裏表紙)を使用。
...
BACK_COVER_IMG = os.path.join(COVER_IMG_DIR, "cover_back_shiga_biwako.png")
FRONT_COVER_IMG = os.path.join(COVER_IMG_DIR, "cover_front_fukuoka_dazaifu.png")
...
OUT_PATH = os.path.join(ROOT, "build", "journey_through_western_japan_cover.pdf")

TITLE = "Journey Through Western Japan"
SUBTITLE = "An Adult Coloring Book of Iconic Places from Shiga to Okinawa"
SUBTITLE2 = "23 Scenic Landmarks"
AUTHOR = "Osakanian"

BACK_BLURB = [
    "Travel page by page across western Japan — from the floating",
    "shrine of Lake Biwa to the shores of Okinawa — with 23",
    "hand-picked, real-world landmarks brought to life in line art.",
    "",
    "Inside this book you'll find:",
    "  - 23 detailed illustrations of real, named locations across",
    "     western Japan",
    "  - Single-sided pages to prevent bleed-through",
    "  - Printed on 8.5\" x 11\" pages, perfect for markers, gel pens,",
    "     colored pencils, or fine-tip markers",
    "  - Castles, shrines, temples, gardens, volcanoes, and coastlines",
    "     from Kansai to Kyushu and Okinawa",
    "",
