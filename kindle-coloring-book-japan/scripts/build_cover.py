...
flower_mandalas 版と同じ計算式・同じ余白ルールを踏襲。
...
OUT_PATH = "/home/user/osakanian-shopping-list/kindle-coloring-book-japan/build/japanese_landscapes_cover.pdf"

TITLE = "Japanese Landscapes"
SUBTITLE = "An Adult Coloring Book for Stress Relief & Relaxation"
SUBTITLE2 = "25 Scenic Illustrations of Japan"
AUTHOR = "Osakanian"

BACK_BLURB = [
    "Take a peaceful journey through the landscapes of Japan — from",
    "Mount Fuji at dawn to bamboo groves, torii gates, and quiet",
    "temple gardens.",
    "",
    "Inside this book you'll find:",
    "  - 25 original, hand-crafted scenic illustrations",
    "  - Single-sided pages to prevent bleed-through",
    "  - Printed on 8.5\" x 11\" pages, perfect for markers, gel pens,",
    "     colored pencils, or fine-tip markers",
    "  - Mount Fuji, torii gates, pagodas, cherry blossoms, koi ponds,",
    "     bamboo groves, and more",
    "",
...
def draw_front_cover(c, x0):
    ...
    c.setLineWidth(1.2)
    c.setStrokeColor(black)
    c.line(cx - 150, title_y - 20, cx + 150, title_y - 20)
